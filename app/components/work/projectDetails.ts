...
export const projects = [
  {
    id: 0,
    name: "ZIMS WEBSITE",
    description: "Zoo Information Management System ",
    technologies: [SiTailwindcss, SiReact, SiNodedotjs],
    techNames: ["Tailwind", "React", "GSAP", "THREE.JS"],
    github: "https://github.com/Essien1/zoo-app",
    demo: "https://zimsapp.netlify.app/",
    image: "/projects/zims.png",
    available: true
  },
  {
    id: 2,
